...
Recommended_Recolabs_Tag_ALL = predict(rec_rnd, temp_all[], n = 10)
...
Recommended_Recolabs_Tag_ALL_SVD = predict(rec_svd, temp_all[], n = 10)
...
Recommended_Recolabs_Tag_ALL_POP = predict(rec_pop, temp_all[], n = 10)
...
Recommended_Recolabs_Tag_ALL_U2U = predict(rec, temp_all[], n = 10)
...
Recommended_Recolabs_Tag_ALL_ITEM = predict(rec_i, temp_all[], n = 10)
